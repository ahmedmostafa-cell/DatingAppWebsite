...
namespace API.Controllers
{
    public class AdminController : BaseApiController
    {
        ...
        public AdminController(IPhotoService photoService, UserManager<AppUser> userManager, IUnitOfWork uow)
        {
        ...
        {
            if (string.IsNullOrEmpty(roles)) return BadRequest("You Must Choose At Least One Role");
